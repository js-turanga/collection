...
describe( "keyBy -", function() {
    ...
    const data = [
        { id: 100, product: 'Chair', manufacturer: 'IKEA', price: '1490 NOK' }, 
        { id: 150, product: 'Desk', manufacturer: 'IKEA', price: '900 NOK' }, 
        { id: 200, product: 'Chair', manufacturer: 'Herman Miller', price: '9990 NOK' }
    ];
    ...
    it( 'should key the collection by the given key', function() {
        ...
        expect( keyed.all() ).to.eql( {
            IKEA: { id: 150, product: 'Desk', manufacturer: 'IKEA', price: '900 NOK' },
            'Herman Miller': { id: 200, product: 'Chair', manufacturer: 'Herman Miller', price: '9990 NOK' },
        } );
    ...
    it( 'should only keep one items per key', function() {
        ...
        expect( keyed.all() ).to.eql( {
            'Liverpool FC': { name: 'Mohamed Salah', club: 'Liverpool FC' },
        } );
    } );


    it( 'should key everything by an empty string if key does not exist', function() {
    ...
    it( 'should be able to use nested value as key', function() {
        ...
        const collection = collect( [
            { name: 'Virgil van Dijk', club: { name: 'Liverpool FC' } },
            { name: 'Sadio Mané', club: { name: 'Liverpool FC' } },
        ] );
