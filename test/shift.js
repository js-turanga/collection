...
describe( "shift -", function() {
    ...
    it( 'should return the first n item and remove it from the collection', function() {
    ...
    it( 'should modify the collection, unlike first()', function() {
    ...
    it( 'should return the first n values when collection is based on an object', function() {
    ...
    it( 'should return null when shifting an empty collection', function() {
