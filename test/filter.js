...
describe( "filter -", function() {
    ...
    it( 'should filter the collection by a given callback, filtering based on key', function() {
    ...
    it( 'should filter the collection removing "falsely" values if no call back is passed', function() {
    
        const collection = collect( [
            0, 1, 2, null, 3, 4, undefined, 5, 6, 7, [], 8, 9, {}, [ 10 ],
        ] );
