...
describe( "sum -", function() {
    ...
    it( 'should return the sum of collection values by key', function() {
    ...
    it( 'should return the sum of the provided closure', function() {
    ...
    it( 'should return sum of closure when collection is object with objects', function() {
    ...
    it( 'should strip a number to nearest right number', function() {
