...
describe( "only -", function() {
    ...
    const post = { id: 1, title: 'My first post!', author: 'ecrmnn' };


    it( 'should only return the specified properties of an object', function() {
    ...
    it( 'should only return the specified items in an array', function() {
