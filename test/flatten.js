...
describe( "flatten -", function() {
    ...
    it( 'should flatten nested arrays and objects', function() {
        ...
        const collection2 = collect( data );
        ...
        const flattened3 = collect( data ).flatten();

        expect( flattened3.all() ).to.eql( [ 'iPhone 6S', 'Apple', 'Galaxy S7', 'Samsung' ] );
    } );


    it( 'should flatten null', function() {
    ...
    it( 'should flatten undefined', function() {
    ...
    it( 'should not throw exceptions when encountering null', function() {
    ...
    it( 'should flatten an object with objects', function() {
