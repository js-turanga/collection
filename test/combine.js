...
describe( "combine -", function() {
    ...
    it( 'should work when the collection is a string', function() {
    ...
    it( 'should be able to combine with a string', function() {
    ...
    it( 'should be able to combine with the values of an object', function() {
    ...
    it( 'should be able to combine with a collection', function() {
