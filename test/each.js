...
describe( "each -", function() {
    ...
    it( 'should stop iterating, when returning false with objects', function() {
    ...
    it( 'should iterate even when the collection is an object', function() {
    ...
    it( 'should returns the original collection', function() {
