...
describe( "pluck -", function() {
    ...
    it( 'should return null when an object is missing the key', function() {
    ...
    it( 'should be able to pluck key and value pairs', function() {
    ...
    it( 'should return an array when only plucking values', function() {
    ...
    it( 'should return an object when plucking key and value pairs', function() {
    ...
    it( 'should use empty string as key if object is missing property', function() {
    ...
    it( 'should use null as value if value is missing', function() {
    ...
    it( 'should not return null instead of 0', function() {
    ...
    it( 'should allow wildcard dot notation', function() {

        const users = collect( [
            { name: 'John', roles: [ { name: 'Editor' }, { name: 'Admin' } ] }
        ] );

        expect( users.pluck( '*' ).all() ).to.eql( [
            'John', [ { name: 'Editor' }, { name: 'Admin' } ],
        ] );
    ...
    it( 'should allow null as value in wildcard', function() {

        const users = collect( [
            { name: 'John', roles: [ { name: 'Editor' }, { name: null } ] }
        ] );
    ...
    it( 'should allow undefined as value in wildcard', function() {

        const users = collect( [
            { name: 'John', roles: [ { name: 'Editor' }, { name: undefined } ] }
        ] );
    ...
    it( 'should allow symbol as value in wildcard', function() {

        const symbol = Symbol( 'Foo' );

        const users = collect( [
            { name: 'John', roles: [ { name: 'Editor' }, { name: symbol } ] }
        ] );
    ...
    it( 'should allow multiple wildcards', function() {
