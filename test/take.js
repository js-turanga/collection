...
describe( "take -", function() {
    ...
    it( 'should take from the end of the collection when passed a negative integer', function() {
    ...
    it( 'should work when the collection is based on an object', function() {
        ...
        const collection = collect( { name: 'Sadio Mané', number: 19, club: 'Liverpool FC', } );
        ...
        expect( collection.all() ).to.eql( { name: 'Sadio Mané', number: 19, club: 'Liverpool FC', } );
    } );
} );
