...
describe( "sortBy -", function() {
    ...
    it( 'should sort string date before integers and integers before null', function() {
    ...
    it( 'should sort strings before integers and integers before null', function() {
    ...
    it( 'should sort strings before integers and integers before null when using a callback function', function() {
    ...
    it( 'should sort nested data with dot notation', function() {
