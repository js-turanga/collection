...
describe( "skipWhile -", function() {
    ...
    it( 'should skip all values before a given value appears', function() {
    ...
    it( 'should work with collection based on an object', function() {
    ...
    it( 'should work when multidimentional', function() {
        
        const data = [
            { name: 'Sadio Mané', number: 10, club: 'Liverpool FC' }, 
            { name: 'Mohamed Salah', number: 11, club: 'Liverpool FC' }
        ];
